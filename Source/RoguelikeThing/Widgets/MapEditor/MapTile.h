...
public:
	...
	//ѕереопределение виртуальной функции дл€ удалени€ всех €чеек
	void RemoveAllCells() override;
	void SetMyCoord(FCellCoord myCoord) override;
	//ѕереопределение виртуальной функции дл€ сброса состо€ни€ изменЄнных €чеек
	...
	//‘ункци€, задающа€ стили €чеек исход€ из переменной предзагрузки MyTerrainOfTile
	UFUNCTION(BlueprintCallable)
